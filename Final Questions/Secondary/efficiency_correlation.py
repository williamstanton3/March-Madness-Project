...
df = df[df["Round"] != "Did Not Make Final Four"]  # <-- filter here

round_order = ["Champion", "Runner Up", "Final Four"]
round_colors = {
    "Champion": "#534AB7",
    "Runner Up": "#1D9E75",
    "Final Four": "#D85A30",
...
for round_label in round_order:
    ...
    fig.add_trace(go.Scatter(
        ...
        hoverinfo="text",
        marker=dict(color=round_colors[round_label], size=9, opacity=0.85, line=dict(width=0.5, color="white"))
    ))
