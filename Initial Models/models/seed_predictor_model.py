...
Handles loading data, training Seed prediction models, and returning metrics including baseline.
"""
...
def train_models_and_get_accuracies(model_types=None, input_file=INPUT_FILE, test_size=0.2, save_models=True):
    ...
    for model_type in model_types:
        ...
        if save_models:
            model_path = os.path.join(model_dir, f"seed_{model_type}_model.joblib")
